using CarNest.CaregiverPaymentMethod.Interfaces.ACL;
using WebApplication3.Caregivers.Domain.Model.Aggregates;
using WebApplication3.Shared.Domain.Repositories;

namespace CarNest.CaregiverPaymentMethod.Application.ACL;

public class CaregiverPaymentMethodContextFacade : IPaymentMethodContextFacade
{
    private readonly IBaseRepository<Domain.Model.Aggregates.CaregiverPaymentMethod> _paymentMethodRepository;
    private readonly IBaseRepository<Caregiver> _caregiverRepository;

    public CaregiverPaymentMethodContextFacade(
        IBaseRepository<Domain.Model.Aggregates.CaregiverPaymentMethod> paymentMethodRepository,
    ...
    public async Task<int> CreateCaregiverPaymentMethodAsync(Domain.Model.Aggregates.CaregiverPaymentMethod caregiverPaymentMethod)
    {
        {
    ...
    public async Task<IEnumerable<Domain.Model.Aggregates.CaregiverPaymentMethod>> GetCaregiverPaymentMethodsByUserAsync(int caregiverId)
    {
