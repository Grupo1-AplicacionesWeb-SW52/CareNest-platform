...
namespace WebApplication3.CaregiverPaymentMethod.Application.Internal.CommandServices;
...
public class CaregiverPaymentMethodCommandService : ICaregiverPaymentMethodCommandService
{
    ...
    public async Task<CaregiverPaymentMethod.Domain.Model.Aggregates.CaregiverPaymentMethod?> Handle(CreateCaregiverPaymentCommand command)
    {
        // Validate input
        ...
        var paymentMethod = new CaregiverPaymentMethod.Domain.Model.Aggregates.CaregiverPaymentMethod(
            command.CardNumber,
    ...
    public async Task<CaregiverPaymentMethod.Domain.Model.Aggregates.CaregiverPaymentMethod?> Handle(UpdateCaregiverPaymentCommand command)
    {
